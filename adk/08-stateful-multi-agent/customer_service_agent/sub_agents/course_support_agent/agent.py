...
course_support_agent = Agent(
    ...
    instruction="""
    You are the course support agent for the AI Marketing Platform course.
    Your role is to help students with their questions and concerns about the course.
    ...
    - Course infomation is stored as objects with "id" and "purchase_date" properties
